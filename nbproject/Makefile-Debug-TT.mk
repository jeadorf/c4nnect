...
# C Compiler Flags
CFLAGS=-m32 -std=c99 -Wextra -pedantic-errors -DDEBUG -DDISABLE_TTABLE
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug-TT.mk dist/Debug-TT/GNU-Linux-x86/fourinarow

dist/Debug-TT/GNU-Linux-x86/fourinarow: ${OBJECTFILES}
	${MKDIR} -p dist/Debug-TT/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug-TT
	${RM} dist/Debug-TT/GNU-Linux-x86/fourinarow
