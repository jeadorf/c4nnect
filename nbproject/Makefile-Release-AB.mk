...
# C Compiler Flags
CFLAGS=-m64 -std=c99 -Wextra -DDISABLE_ABCUTS
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release-AB.mk dist/Release-AB/GNU-Linux-x86/fourinarow

dist/Release-AB/GNU-Linux-x86/fourinarow: ${OBJECTFILES}
	${MKDIR} -p dist/Release-AB/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release-AB
	${RM} dist/Release-AB/GNU-Linux-x86/fourinarow
