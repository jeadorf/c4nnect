...
# C Compiler Flags
CFLAGS=-m64 -std=gnu99 -Wextra -DBENCHMARK
...
${OBJECTDIR}/ucitable.o: ucitable.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/ucitable.o ucitable.c
...
${OBJECTDIR}/ucitable_test.o: ucitable_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/ucitable_test.o ucitable_test.c
