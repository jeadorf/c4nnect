...
# C Compiler Flags
CFLAGS=-m64 -std=c99 -Wextra -DDISABLE_TTABLE -DDISABLE_ABCUTS
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release-TT-AB.mk dist/Release-TT-AB/GNU-Linux-x86/fourinarow

dist/Release-TT-AB/GNU-Linux-x86/fourinarow: ${OBJECTFILES}
	${MKDIR} -p dist/Release-TT-AB/GNU-Linux-x86
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release-TT-AB
	${RM} dist/Release-TT-AB/GNU-Linux-x86/fourinarow
